...
Для введених даних про різні тарифні пакети і очікувану кількість хвилин щомісячних розмов обчислити сумарну вартість
цих розмов для кожного пакету і визначити найдешевший і найдорожчий.*/
#include <iostream>
#include "windows.h"
